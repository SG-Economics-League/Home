...
export default function PractisePeriodSection() {
    return <section className="w-full bg-[#fbfafb] py-16">
        <div className="max-w-screen-lg mx-auto px-4 md:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 grid-rows-2 lg:grid-rows-1 items-stretch gap-20">
            <div className="h-full w-full relative">
                <Image
                src="/graphics/competitionWebsite.png"
                alt="Website Design"
                fill={true}
                className="bg-[#f3f5fa] hidden md:block mx-auto h-full w-full object-contain shadow-xl rounded-lg overflow-hidden border border-gray-200"
              />
            </div>
            <div>
              <Image
